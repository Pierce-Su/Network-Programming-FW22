...
void modifyS3File(int add){
    ...
    Aws::InitAPI(options);
    {
        ...
        const Aws::String myBucketName = "genghisswan";
        const Aws::String myObjectName = "server_status03.txt";
        const Aws::String otherObjectName_A = "server_status01.txt";
        const Aws::String otherObjectName_B = "server_status02.txt";
        const std::string myObjectContent = "0\n";
        Aws::S3::S3Client s3Client;
...
int myStatus(char* cpyStr){
    ...
    Aws::InitAPI(options);
    {
        ...
        getObjectRequest01.SetKey(otherObjectName_A);
        ...
        getObjectRequest02.SetKey(otherObjectName_B);
        ...
        getObjectRequest03.SetKey(myObjectName);
